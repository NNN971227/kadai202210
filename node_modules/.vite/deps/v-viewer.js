  ...
  zoomTo: function zoomTo(ratio) {
    ...
    if (isNumber(ratio) && this.viewed && !this.played && (_zoomable || options.zoomable)) {
      ...
      if (_originalEvent) {
        ...
        imageData.x -= offsetWidth * ((pivot.x - x2) / width);
        imageData.y -= offsetHeight * ((pivot.y - y2) / height);
      } else {
...
var g = "object" == typeof p && p && p.Object === Object && p;
var h2 = g;
var j = "object" == typeof self && self && self.Object === Object && self;
...
var V = function(e) {
  return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : P && P in Object(e) ? S(e) : M(e);
};
var D = function(e) {
  var t = typeof e;
...
var be = ve;
var ye = function(e) {
  return null != e && be(e.length) && !de(e);
};
var we = /^(?:0|[1-9]\d*)$/;
var ge = function(e, t) {
  var r = typeof e;
  return !!(t = null == t ? 9007199254740991 : t) && ("number" == r || "symbol" != r && we.test(e)) && e > -1 && e % 1 == 0 && e < t;
};
var he = pe;
var je = ye;
var me = ge;
...
var _e = function(e, t, r) {
  if (!Oe(r))
    return false;
  var n = typeof t;
  return !!("number" == n ? je(r) && me(t, r.length) : "string" == n && t in r) && he(r[t], e);
};
var $e = function(e, t) {
...
var Fe;
var Ue = function(e) {
  return Te(e) && "[object Arguments]" == Ae(e);
};
var Ce = xe;
...
var ft = function(e, t) {
  ...
  for (var f in e)
    !t && !at.call(e, f) || u && ("length" == f || o && ("offset" == f || "parent" == f) || i && ("buffer" == f || "byteLength" == f || "byteOffset" == f) || ut(f, a)) || c.push(f);
  return c;
};
...
var yt = function(e) {
  ...
  var t = pt(e), r = [];
  for (var n in e)
    ("constructor" != n || !t && dt.call(e, n)) && r.push(n);
  return r;
};
var wt = ye;
var gt = le;
...
var $t = gt(function(e, t) {
  ...
  for (o && jt(t[0], t[1], o) && (n = 1); ++r < n; )
    for (var i = t[r], u = mt(i), c = -1, a = u.length; ++c < a; ) {
      var f = u[c], s = e[f];
      (void 0 === s || ht(s, Ot[f]) && !_t.call(e, f)) && (e[f] = i[f]);
    }
  return e;
});
var xt = "undefined" != typeof window && null !== window;
!function() {
...
function Et(e) {
  return "function" == typeof e || "[object Object]" === toString.call(e);
}
function It(e) {
...
function St(e, ...t) {
  ...
  if (0 === t.length || "function" != typeof Symbol || "function" != typeof Tt)
    return e;
  for (const r of t) {
    const t2 = Tt(r);
    for (const n of t2)
...
function Mt(e, ...t) {
  let r = 0;
  var n;
  for (("object" == typeof (n = e) ? null === n : "function" != typeof n) && (e = t[r++]), e || (e = {}); r < t.length; r++)
    if (Et(t[r])) {
...
var Pt = ({ images: n = [], options: o }) => {
  o = Mt(o, { inline: false });
  const i = document.createElement("div"), u = h("div", { style: { display: "none" }, class: ["__viewer-token"] }, n.map((e) => h("img", "string" == typeof e ? { src: e } : e)));
  render(u, i);
...
var kt = D;
var Bt = function(e) {
  return "symbol" == typeof e || Wt(e) && "[object Symbol]" == Ct(e);
};
var Rt = /^[-+]0x[0-9a-f]+$/i;
var Lt = /^0b[01]+$/i;
var qt = /^0o[0-7]+$/i;
...
var Xt = function(e, t, r) {
  ...
  function b2(e2) {
    var r2 = e2 - a;
    return void 0 === a || r2 >= t || r2 < 0 || l && e2 - f >= i;
  }
  function y2() {
    var e2 = Ht();
    if (b2(e2))
  ...
  function g2() {
    ...
    return void 0 === c && (c = setTimeout(y2, t)), u;
  }
  return t = Kt(t) || 0, Gt(r) && (s = !!r.leading, i = (l = "maxWait" in r) ? Jt(Kt(r.maxWait) || 0, t) : i, p2 = "trailing" in r ? !!r.trailing : p2), g2.cancel = function() {
    void 0 !== c && clearTimeout(c), f = 0, n = a = o = c = void 0;
  }, g2.flush = function() {
    return void 0 === c ? u : w2(Ht());
  }, g2;
};
